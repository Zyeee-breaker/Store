...
// rizky aprianzah sudah di cek pMoko
include "config.php"; // Menyertakan file koneksi.php yang berisi kode untuk menghubungkan ke database
...
if (isset($_GET['id'])) {
    ...
    if ($query) {
        ...
        header("Location: view.php"); // Arahkan pengguna ke halaman lihat.php
