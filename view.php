...
if ($query->num_rows > 0) {
    ...
    echo "<a href='add.php'>Tambah barang</a><br><br>";
    ...
    while ($data = mysqli_fetch_array($query)) {
        ...
        <td><a href='edit.php?id={$data['id_barang']}'>Edit</a> | <a href='delete.php?id={$data['id_barang']}'>Hapus</a></td> <!-- Link untuk aksi edit dan hapus -->
    </tr>
    ";
}
